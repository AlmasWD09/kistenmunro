                ...
                <div className="w-full py-8 md:py-12">
                        ...
                        <div className="mb-8">
                            ...
                            <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                                We are London Apostille Services Ltd, an FCDO-registered apostille facilitator (agent) with 15+ years of experience. <span className="underline cursor-pointer">Book a free consultation</span> with our team today to get your documents apostilled in 24 hours.
                            </p>
                        </div>
                        ...
                        <div className="mb-8">
                            ...
                            <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-3">
                                <span className="underline cursor-pointer">Various countries</span>, including the UK, adopted <span className="underline cursor-pointer">the Hague Apostille Convention</span> to streamline document legalisation processes. The convention replaced several complex processes with a single certification, an apostille.
                            </p>
                            <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-3">
                                As the convention required, the UK designated a competent authority, <span className="underline cursor-pointer" >the FCDO</span>, to issue apostilles. The FCDO legalises documents for international use by attaching an apostille certificate to them.
                            </p>
                            <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                        ...
                        <div className="mb-8">
                            ...
                            <div className="mb-6">
                                ...
                                <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-2">
                                    <span className="font-semibold">How it works:</span> Apply online, pay, then post your document to the FCDO. If the signature/stamp cannot be verified, the FCDO will not legalise it, and you will not be refunded.
                                </p>
                                <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-2">
                                    <span className="font-semibold">Typical timeframe:</span> Expect roughly 15–21 days end-to-end (the standard postal service is commonly quoted as 2–4 weeks, depending on workload and post/courier time).
                                </p>
                                <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                                    <span className="font-semibold">When to choose:</span> You're confident the document is in the exact format the FCDO accepts (correct original/certified copy, correct UK public official, no missing dates/seals). Mistakes lead to rejection and no FCDO refund.
                                </p>
                            </div>
                            ...
                            <div className="mb-6">
                                ...
                                <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-2">
                                    <span className="font-semibold">How it works:</span> A specialist agency (registered as an FCDO business customer) pre-checks your paperwork, arranges any UK solicitor/notary certification needed, submits it to the FCDO, and manages collection/return.
                                </p>
                                <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-2">
                                    <span className="font-semibold">Typical timeframe:</span> Frequently 1–2 working days once documents are in order (subject to FCDO capacity and agency cut-offs).
                                </p>
                                <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                                    <span className="font-semibold">Why choose this:</span> Faster logistics, expert pre-screening to avoid FCDO rejections, and one point of contact. (Many reputable apostille agencies offer their own refund/resubmission guarantees if the FCDO rejects—this is the agency's policy, not the FCDO's.)
                                </p>
                            </div>

                            <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-4">
                                <span className="font-semibold">Note:</span> There is also a separate e-Apostille route for eligible digitally-signed documents (apply online, upload the file). Acceptance varies by recipient/country; paper apostilles remain widely used.
                            </p>
                        ...
                        <div className="mb-8">
                            ...
                            <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-3">
                                <span className="font-semibold">A solicitor:</span> Is a legal professional providing a broad range of legal services, primarily focusing on UK law. They can certify copies and declarations for legalisation.
                            </p>
                            <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-3">
                                <span className="font-semibold">A notary:</span> Is a legal professional whose primary role is to deal with documents for international use. They verify the authenticity of documents, signatures, and facts.
                            </p>
                            <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-3">
                        ...
                        <div className="mb-8">
                            ...
                            <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-3">
                                You can <span className="underline cursor-pointer">apply for an e-Apostille</span> or a paper apostille, and anyone can verify a UK apostille on the official GOV.UK checker.
                            </p>
                            <p className="text-sm md:text-base text-gray-700 leading-relaxed mb-3">
